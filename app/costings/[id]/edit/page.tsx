    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        <SectionEquipment
          ...
          moTotal={(quoteWithCostingData.itemsMO || []).reduce((sum: number, item: QuoteItemMO) => sum + (item.subtotal || 0), 0)}
      ...
      {totals && <ResumenEjecutivo totals={totals as unknown as QuoteTotals} />}
